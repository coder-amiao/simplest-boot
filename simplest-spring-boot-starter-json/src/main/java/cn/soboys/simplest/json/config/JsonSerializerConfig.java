package cn.soboys.simplest.json.config;

import cn.soboys.simplest.json.property.JsonSerializeProperties;
import cn.soboys.simplest.json.serializer.*;
...
public class JsonSerializerConfig {
    ...
    @Bean
    public JsonSerializeProperties jsonSerializeProperties() {
        return new JsonSerializeProperties();
    }
